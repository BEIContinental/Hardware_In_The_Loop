...
void DifferentialModelClass::step()
{
  ...
  if (Differential_U.PLA_N * Differential_U.signal1 >=
      Differential_P.Switch_Threshold) {
    tmp = Differential_P.ra_transmission_efficiency * Differential_U.signal1;
  } else {
    tmp = (2.0 - Differential_P.ra_transmission_efficiency) *
      Differential_U.signal1;
  }
  ...
  if (Differential_U.PLA_N * Differential_U.signal2 >=
      Differential_P.Switch_Threshold) {
    tmp = Differential_P.ra_transmission_efficiency * Differential_U.signal2;
  } else {
    tmp = (2.0 - Differential_P.ra_transmission_efficiency) *
      Differential_U.signal2;
  }
  ...
  if (Differential_U.PLA_N * Differential_U.signal3 >=
      Differential_P.Switch_Threshold) {
    tmp = Differential_P.ra_transmission_efficiency * Differential_U.signal3;
  } else {
    tmp = (2.0 - Differential_P.ra_transmission_efficiency) *
      Differential_U.signal3;
  }
